                ...
                @foreach($cities as $key => $value)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('deletecities',$value->id) }}"  class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                @endforeach
                </tfoot>
        ...
        <div class="modal" id="modaldemo8">
            ...
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة محافظة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                <form action="{{route('storecities')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
