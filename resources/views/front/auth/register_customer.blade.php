                    ...
                    <div class="authentication_card">
                       ...
                       {{-- @include('../parts.alert') --}}
                        ...
                        <div class="authentication_form">
                            <form action="{{ route('register_acuant') }}" enctype='multipart/form-data' method="post">
                                {{csrf_field()}}
                                ...
                                <button type="submit" class="btn-animation-1 submit_btn">اشترك الأن</button>
                                
                            </form>
                            
                            <div class="register-text">
                                اذا كنت تمتلك حساب <a href="{{ route('change_type_login') }}">سجل الدخول</a>
                            </div>
                        </div>
                    </div>
                </div>
