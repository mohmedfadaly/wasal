...
<body>
    <main>
                ...
                <div class="row align-items-center justify-content-between bg-w">
                    ...
                    <div class="col-md-2">
                        <ul class="actions_header align-items-center justify-content-end">
                            ...
                            <li>
                                <a href="{{ route('loginprovider') }}" class="btn-animation-1">
                                    تخطي
                                </a>
                            </li>
                        </ul>
        ...
        <div class="container mt-5">
            <form class="row align-items-center justify-content-center" id="regForm" action="{{ route('register_complate') }}" enctype='multipart/form-data' method="post">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{CurrentAuth()['user']->id}}">
                <div class="col-md-12">
                    ...
                    <div class="tab">
                        <div class="prev-image">
                            <label for="formFile" class="prev-image-label">
                                <input class="form-control d-none" name="avatar" oninput="this.className = 'form-control d-none'"
                        ...
                        <div class="authentication_form authentication_form_custom row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="city_id"  class="form-select cities" aria-label="Default select example">
                        ...
                        <div class="authentication_form authentication_form_custom row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="section_id" required class="form-select" aria-label="Default select example">
                                        <option disabled selected>اختر المجال</option>
                            ...
                            <div class="col-md-12 ">
                                <div class="btn-group-custom">
                                    <div class="single_check">
                                        <input type="checkbox" class="btn-check" name="service" value="1" id="addServ"
                                            autocomplete="off">
                                        <label for="addServ">اضافة خدمة </label>
                                    </div>
                                    <div class="single_check">
                                        <input type="checkbox" class="btn-check" name="article" value="1"  id="addArticle"
                                            autocomplete="off">
                                        <label for="addArticle"> اضافة مقال</label>
                                    </div>
                                    <div class="single_check">
                                        <input type="checkbox" class="btn-check" name="podcast" value="1"  id="addBodcast"
                                            autocomplete="off">
                                        <label for="addBodcast"> اضافة بودكاست</label>
                                    </div>
                                    <div class="single_check">
                                        <input type="checkbox" class="btn-check" name="sociaty" value="1"  id="addQue"
                                            autocomplete="off">
                                        <label for="addQue"> اضافة سؤال</label>
                                    </div>
                                    <div class="single_check">
                                        <input type="checkbox" class="btn-check" name="consult" value="1"  id="addEst4"
                                            autocomplete="off">
                                        <label for="addEst4">اضافة استشارة</label>
                                    </div>
                                    <div class="single_check">
                                        <input type="checkbox" class="btn-check" name="video" value="1"  id="addVideo"
                                            autocomplete="off">
