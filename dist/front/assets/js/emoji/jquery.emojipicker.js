(function ($) {
  ...
  var categories = [
    { name: "people", label: "اشخاص" },
    { name: "nature", label: "طبيعة" },
    { name: "food", label: "طعام" },
    { name: "activity", label: "نشاطات" },
    { name: "travel", label: "السفر والأماكن" },
    { name: "object", label: "أشياء" },
    { name: "symbol", label: "رموز" },
    { name: "flag", label: "اعلام" },
  ];
  ...
  function getPickerHTML() {
    ...
    if (localStorageSupport) {
      ...
      nodes.push('<h1>مستخدم حديثا</h1><div class="wrap">');
